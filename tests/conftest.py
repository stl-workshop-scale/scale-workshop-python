...
def client(request: FixtureRequest) -> Iterator[ScaleWorkshop]:
    ...
    with ScaleWorkshop(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncScaleWorkshop]:
    ...
    async with AsyncScaleWorkshop(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
