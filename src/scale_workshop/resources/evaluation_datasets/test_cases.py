...
from ...types.evaluation_datasets.test_case_delete_response import TestCaseDeleteResponse
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/v4/evaluation-datasets/{evaluation_dataset_id}/test-cases",
            page=SyncPageNumberPage[TestCase],
            options=make_request_options(
...
class AsyncTestCasesResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[TestCase, AsyncPageNumberPage[TestCase]]:
        """
        ### Description
        ...
        return self._get_api_list(
            f"/v4/evaluation-datasets/{evaluation_dataset_id}/test-cases",
            page=AsyncPageNumberPage[TestCase],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
